CREATE TABLE STM_EVENT_TB (
STM_SQ BIGINT(20) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '고유 번호',
...
CREATE INDEX STM_EVENT_TB_IDX1 ON STM_EVENT_TB (STM_UG_SQ);
