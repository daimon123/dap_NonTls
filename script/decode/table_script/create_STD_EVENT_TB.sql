CREATE TABLE STD_EVENT_TB (
STD_SQ BIGINT(20) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '고유 번호',
...
CREATE INDEX STD_EVENT_TB_IDX1 ON STD_EVENT_TB (STD_UG_SQ);
