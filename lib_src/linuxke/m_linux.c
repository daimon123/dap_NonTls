...
/*-------------------------------------------------
	...
	memory_stats[0] = strtoul(p, &p, 10)/1024;
	memory_stats[1] = strtoul(p, &p, 10)/1024;
	memory_stats[2] = strtoul(p, &p, 10)/1024;
	memory_stats[3] = strtoul(p, &p, 10);

	p = strchr(p, '\n');
	p = skip_token(p);			// "Swap:" 
	p = skip_token(p);			// total swap 
	memory_stats[4] = strtoull(p, &p, 10)/1024;
	memory_stats[5] = strtoul(p, &p, 10)/1024;
