        ...
        int*                buffLen)
{
    ...
    *buffLen += sizeof(DetectData.MainBoard);
    ...
    nRet = frd_MergeHwBaseTb(	&Detect->AgentInfo,
                                Detect->detect_time,
        ...
        int*                buffLen)
{
    ...
    *buffLen += sizeof(DetectData.System);
    ...
    nRet = frd_MergeSystemTb(Detect->AgentInfo.user_key,
    ...
    else
    {
        ...
        if (stLen > 0 && fjson_GetLengthSystemVmSummary(DetectData.System.st_summary) == 0)
            return 0;
        nRet = frd_MergeEventTb(EventParam, stLen);
        if (nRet < 0)
        {
        ...
        int*		        buffLen )
{
    ...
    *buffLen += sizeof(DetectData.ConnectExt);
    ...
    nRet = frd_MergeConnectExtTb(Detect->AgentInfo.user_key,
                                  Detect->AgentInfo.user_seq,
                                  Detect->detect_time,
    ...
    else
    {
        ...
        memset(EventParam, 0x00, sizeof(_DAP_EventParam));
        strncpy(EventParam->user_key, Detect->AgentInfo.user_key, sizeof(EventParam->user_key) );
        strncpy(EventParam->user_ip, Detect->AgentInfo.user_ip, sizeof(EventParam->user_ip)    );
        EventParam->user_seq = Detect->AgentInfo.user_seq;
        strncpy(EventParam->detect_time, Detect->detect_time, sizeof(EventParam->detect_time) );
        EventParam->ev_type = CONNECT_EXT_SVR;
        EventParam->ev_level = (DetectData.ConnectExt.ce_rule - '0') % 48;
        strncpy(EventParam->prefix, param_Prefix, sizeof(EventParam->prefix)    );
        strncpy(EventParam->postfix, param_Postfix, sizeof(EventParam->postfix) );
        ...
        int*                buffLen )
{
    ...
    *buffLen += sizeof(DetectData.OperatingSystem);
    ...
    nRet = frd_MergeOsTb(	Detect->AgentInfo.user_key,
                              Detect->AgentInfo.user_seq,
                              Detect->detect_time,
            ...
            int*                buffLen )
{
    ...
    *buffLen += sizeof(DetectData.Cpu);
    ...
    nRet = frd_MergeCpuTb( Detect->AgentInfo.user_key,
                           Detect->AgentInfo.user_seq,
                           Detect->detect_time,
                           &DetectData.Cpu,
                           param_Prefix, param_Postfix);
            ...
            int*    		    buffLen )
{
    ...
    *buffLen += sizeof(DetectData.NetAdapter);
    ...
    rxt = frd_MergeNetAdapterTb(	Detect->AgentInfo.user_key,
                                   Detect->AgentInfo.user_seq,
                                   Detect->detect_time,
    ...
    else
    {
        ...
        stLen = frd_SelectCountDuplByBase(	"IP",
        ...
        stLen = frd_SelectCountDuplByBase(	"MAC",
                                              Detect->AgentInfo.user_key,
                                              &DetectData.NetAdapter,
                                              strDetail );
...

{
    ...
    *buffLen += sizeof(DetectData.Wifi);
    ...
    rxt = frd_MergeWifiTb(Detect->AgentInfo.user_key,
                        Detect->AgentInfo.user_seq,
                        Detect->detect_time,
                        &DetectData.Wifi,
                        param_Prefix, param_Postfix);
...

{
    ...
    *buffLen += sizeof(DetectData.Bluetooth);
    ...
    rxt = frd_MergeBluetoothTb(	Detect->AgentInfo.user_key,
                                 Detect->AgentInfo.user_seq,
                                 Detect->detect_time,
...

{
    ...
    *buffLen += sizeof(DetectData.NetConnection);
    ...
    rxt = frd_MergeNetConnectionTb(	Detect->AgentInfo.user_key,
                                      Detect->AgentInfo.user_seq,
                                      Detect->detect_time,
...

{
    ...
    *buffLen += sizeof(DetectData.Disk);
    ...
    rxt = frd_MergeDiskTb(Detect->AgentInfo.user_key,
                        Detect->AgentInfo.user_seq,
                        Detect->detect_time,
                        &DetectData.Disk,
                        param_Prefix, param_Postfix,
    ...
    else
    {
        ...
        rxt = frd_CheckUnregDisk(&DetectData.Disk, Detect->AgentInfo.user_key);
        ...
        if(((DetectData.Disk.dk_mobile_rule-'0')%48) > 0)
        {
            ...
            if(((DetectData.Disk.dk_mobile_read_rule-'0')%48) == 1)
            {
                ...
                {
                    stLen = frd_GetLengthDiskMobileRead(&DetectData.Disk);
                }
                rxt = frd_MergeEventTb(EventParam, stLen);
                if(rxt < 0)
                {
            ...
            if(((DetectData.Disk.dk_mobile_write_rule-'0')%48) == 1)
            {
                ...
                {
                    stLen = frd_GetLengthDiskMobileWrite(&DetectData.Disk);
                }
                rxt = frd_MergeEventTb(EventParam, stLen);
                if(rxt < 0)
                {
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.ShareFolder);
    ...
    rxt = frd_MergeShareFolderTb(Detect->AgentInfo.user_key,
                                Detect->AgentInfo.user_seq,
                                Detect->detect_time,
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.InfraredDevice);
    ...
    rxt = frd_MergeInfraredDeviceTb(	Detect->AgentInfo.user_key,
                                       Detect->AgentInfo.user_seq,
                                       Detect->detect_time,
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.Process);
    ...
    rxt = frd_MergeProcessTb(	Detect->AgentInfo.user_key,
                               Detect->AgentInfo.user_seq,
                               Detect->detect_time,
                               &DetectData.Process,
                               param_Prefix, param_Postfix);
    ...
    else
    {
        ...
        WRITE_DEBUG(CATEGORY_DEBUG,"Summary Info : [%s]", DetectData.Process.ps_summary);
        ...
        if ( stLen < 2 )
        {
            stLen = fjson_GetLengthProcessAccessSummary(DetectData.Process.ps_summary);
            if ( stLen > 0 )
            {
                rxt = frd_MergeEventTb(EventParam, stLen);
                if(rxt < 0)
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.Router);
    ...
    rxt = frd_MergeRouterTb(	Detect->AgentInfo.user_key,
                              Detect->AgentInfo.user_seq,
                              Detect->detect_time,
                              &DetectData.Router,
                              param_Prefix, param_Postfix);
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.NetPrinter);
    ...
    rxt = frd_MergeNetPrinterTb(	Detect->AgentInfo.user_key,
                                   Detect->AgentInfo.user_seq,
                                   Detect->detect_time,
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.NetScan);
    ...
    rxt = frd_MergeNetScanTb(Detect->AgentInfo.user_key,
                            Detect->AgentInfo.user_seq,
                            Detect->detect_time,
                            &DetectData.NetScan,
                            param_Prefix, param_Postfix);
        ...
        int *buffLen )
{
    ...
    *buffLen += sizeof(DetectData.CpuUsage);
    ...
    rxt = frd_MergeCpuUsageTb( Detect->AgentInfo.user_key,
                             Detect->AgentInfo.user_seq,
                             Detect->detect_time,
                             &DetectData.CpuUsage,
                             param_Prefix, param_Postfix);
